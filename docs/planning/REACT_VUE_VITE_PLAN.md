...
- **Order:** Port a small core set first (e.g. Button, Card, Modal, Tabs, Dropdown, ThemeSwitcher, FormGroup, Input) to establish patterns; then expand to full parity with the 53 components.
