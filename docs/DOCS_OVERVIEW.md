...
All components in the CLI and scaffold; same BEM/CSS for Astro, Svelte, React, Vue, and Vanilla. Each has a doc page with live examples and Astro | Vanilla | Svelte | Vue | React tabs.
