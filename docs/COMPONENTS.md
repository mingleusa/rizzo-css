...
- **React** — Full implementations and docs at [/docs/react](/docs/react); all 50 components have live demos and React/TSX code blocks. Same BEM and behavior as Astro and Svelte. Each React component page shows **Astro | Svelte | React | Vue | Vanilla** Usage tabs (default: React). Copy components from `src/components/react/` or use the tabs on [React](/docs/react), [Astro](/docs/components), or [Vue](/docs/vue) component pages.
- **Vue** — Full implementations and docs at [/docs/vue](/docs/vue); all 50 components have live demos and Vue/SFC code blocks. Same BEM and behavior as Astro, Svelte, and React. Each Vue component page shows **Astro | Svelte | React | Vue | Vanilla** Usage tabs (default: Vue). Copy components from the package scaffold or use the tabs on [Vue](/docs/vue), [Astro](/docs/components), or [React](/docs/react) component pages.
...
|-----------|------------------|--------------|
| **Astro** | [/docs/components/&lt;name&gt;](/docs/components) (e.g. [/docs/components/button](/docs/components/button)) | Full Astro usage with **Astro | Svelte | React | Vue | Vanilla** code tabs (complete, copy-paste examples per framework), live demos, and props. |
...
| **React** | [/docs/react/components/&lt;name&gt;](/docs/react/components) (e.g. [/docs/react/components/button](/docs/react/components/button)) | React usage with **Astro | Svelte | React | Vue | Vanilla** code tabs (default: React), live demo, and same copy-paste examples as Astro pages. |
| **Vue** | [/docs/vue/components/&lt;name&gt;](/docs/vue/components) (e.g. [/docs/vue/components/button](/docs/vue/components/button)) | Vue usage with **Astro | Svelte | React | Vue | Vanilla** code tabs (default: Vue), live demo, and same copy-paste examples as Astro pages. |
...
Use the **framework switcher** ("View as: Astro | Svelte | Vanilla | React | Vue") at the top of any component or theme page to switch between framework docs.
