...
- **React** — Full implementations and docs at [/docs/react](/docs/react); all 53 components have live demos and React/TSX code blocks. Same BEM and behavior as Astro and Svelte. Each React component page shows **Astro | Vanilla | Svelte | Vue | React** Usage tabs (default: React). Copy components from `src/components/react/` or use the tabs on [React](/docs/react), [Astro](/docs/components), or [Vue](/docs/vue) component pages.
- **Vue** — Full implementations and docs at [/docs/vue](/docs/vue); all 53 components have live demos and Vue/SFC code blocks. Same BEM and behavior as Astro, Svelte, and React. Each Vue component page shows **Astro | Vanilla | Svelte | Vue | React** Usage tabs (default: Vue). Copy components from the package scaffold or use the tabs on [Vue](/docs/vue), [Astro](/docs/components), or [React](/docs/react) component pages.
