...
- **React:** Component doc pages under `/docs/react` (all 50 components with live demos and TSX snippets).
- **Vue:** Component doc pages under `/docs/vue` (all 50 components with live demos and SFC snippets).
