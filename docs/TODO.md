...
- **CLI / npm package:** v0.0.83; `pnpm build:package` builds CSS, copies scaffold, prepares vanilla; `files` in package.json include bin, dist, scaffold/*.
