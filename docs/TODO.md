...
- **Package:** Single **rizzo-css** (v0.0.57) — CSS, CLI, and scaffolds for Vanilla, Astro, and Svelte. **Templates:** Landing | Docs | Dashboard | Full (same for init and add); all components; we never overwrite existing files (snippets in RIZZO-SETUP.md). Build: `pnpm build:package`. Docs: [docs/README.md](./README.md).
