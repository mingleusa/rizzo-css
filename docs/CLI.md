...
| Astro | **Landing** | Full Astro base + hero/features page; 52 or pick components. |
...
| Svelte | **Landing** / **Docs** / **Dashboard** | Same pattern as Astro; 52 or pick. |
...
- [x] **Add / init (existing):** Same template choice. Landing/Docs/Dashboard = picker (all 52 or pick). Full = RIZZO-SNIPPET.txt too. All templates write RIZZO-SETUP.md; Full also writes RIZZO-SNIPPET.txt. Detect framework and PM; print correct commands and “To install the package: …”.
