...
| Astro | **Landing** | Full Astro base + hero/features page; 58 or pick components. |
...
- [x] **Add / init (existing):** Same template choice. Landing/Docs/Dashboard = picker (all 58 or pick). Full = RIZZO-SNIPPET.txt too. All templates write RIZZO-SETUP.md; Full also writes RIZZO-SNIPPET.txt. Detect framework and PM; print correct commands and “To install the package: …”.
