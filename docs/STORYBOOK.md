...
- **Rizzo/All Components** — One story that lets you browse all **57 components** from a dropdown (uses the same registry as the docs).
...
- **Blocks/** — Pre-built layouts: **Landing Hero**, **Pricing** (cards grid), **Dashboard** (sidebar + stats), **Docs Layout** (sidebar + main). Same structure and BEM as the Astro/Svelte/Vue/Vanilla block pages.
