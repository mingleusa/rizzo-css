...
- **CDN** — If you use a CDN, **pin the version** (e.g. `rizzo-css@0.0.69`) so cache hits are reliable and you control when to upgrade. Check with `curl -I <url>` that the response is 200.
