...
- **52 Svelte component pages** at `/docs/svelte` (with full Svelte examples; Icons, Navbar, Search, Settings, Theme Switcher, Font Switcher, Sound Effects include the same live standalone example as Astro, e.g. full Search component on the Search doc page).
