...
- **Scaffold docs** — Each scaffold folder ships **RIZZO-README.md** and **RIZZO-LICENSE** (no overwrite of project README/LICENSE). Main and package READMEs reference them. Markdown docs (GETTING_STARTED, FRAMEWORK_STRUCTURE, COMPONENTS, MULTI_FRAMEWORK, PUBLISHING, DESIGN_SYSTEM) are aligned with npm/CLI and what ships.
