...
- **`packages/rizzo-css/`** — Published npm package: `bin/`, `dist/`, `scaffold/` (minimal/, starter/, vanilla/, astro/ with base + variants + components, svelte/ with base + variants + components, config/, shared/, utils/).
