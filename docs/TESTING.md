...
- **A11y axe:** Every component **doc page** (all 50 × 5 frameworks + blocks) is loaded and scanned. So every component is tested in the sense that its doc page must pass axe.
...
| **Component pages** | Covered by axe (all 50 × 5 frameworks) + keyboard/ARIA (subset) | Same a11y specs |
