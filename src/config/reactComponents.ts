...
export const REACT_COMPONENT_SLUGS = [
  ...
  'button', 'button-group', 'cards', 'calendar', 'carousel', 'chart', 'collapsible', 'command',
  'context-menu', 'copy-to-clipboard', 'dashboard', 'direction',
...
const DESCRIPTIONS: Record<string, string> = {
  ...
  chart: 'Data visualization (e.g. bar chart); theme-aware; integrate with Chart.js or use CSS-only bars',
  collapsible: 'Single expand/collapse section (one trigger, one panel)',
  command: 'Command palette (e.g. Cmd+K): searchable list of actions with keyboard navigation',
  ...
  direction: 'RTL/LTR wrapper: sets dir on a container for bidirectional content',
  ...
  'input-otp': 'One-time code input: multiple digit boxes (e.g. 4–6) with auto-focus and paste support',
  kbd: 'Keyboard key styling for shortcuts (e.g. Ctrl+K)',
  label: 'Standalone form label; use with for/id to associate with inputs',
  menubar: 'Horizontal menu bar with dropdown menus (e.g. File, Edit, View); accessible ARIA menubar',
